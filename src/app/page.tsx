        ...
        <ul className="mt-8 flex flex-col gap-6">
          {apps.map((app) => (
            <li key={app.slug}>
              <Link
                href={`/${app.slug}`}
                className="group block border border-border bg-bg-subtle rounded-lg p-5 sm:p-6 md:p-8 transition-colors hover:border-ink/30 focus-visible:outline focus-visible:outline-2 focus-visible:outline-ink focus-visible:outline-offset-2"
              >
